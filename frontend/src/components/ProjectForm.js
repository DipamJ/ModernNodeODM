            ...
            <Tab eventKey="project" title="Project">
              <Container className="container-custom">
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <LoadScript googleMapsApiKey="AIzaSyB6ex-kEqQDcoRUKZpA6t9cDRYu_rOHjSI">
                    <GoogleMap mapContainerStyle={{ width: "100%", height: "300px" }} zoom={8} center={mapCenter} onClick={handleMapClick}>
